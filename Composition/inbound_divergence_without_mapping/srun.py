...
if __name__ == '__main__':
    ...
    with open("s_performance_across_divergence", 'wb') as out_file:
        pickle.dump(performance_across_K, out_file)
    # with open("s_learn_across_divergence", 'wb') as out_file:
    #     pickle.dump(learn_count_across_K, out_file)
    with open("s_deviation_across_divergence", 'wb') as out_file:
