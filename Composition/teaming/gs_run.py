...
# mp version
def func(N=None, K=None, state_num=None, expertise_amount=None, team_num=None,
    ...
    for _ in range(team_num):
        ...
        teams.append([generalist, specialist])
    for team in teams:
        for _ in range(search_iteration):
            team[0].search()
            cognition = team[0].cog_state
            team[1].state = team[1].cog_state_2_state()
