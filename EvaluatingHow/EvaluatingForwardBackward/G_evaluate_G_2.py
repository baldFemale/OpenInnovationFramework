...
if __name__ == '__main__':
    ...
    for roll_forward in roll_forward_list:
        for roll_back in roll_back_list:
            ...
            with open("gg_performance_across_K_time_forward_{0}_backward_{1}".format(roll_forward, roll_back), 'wb') as out_file:
                pickle.dump(performance_across_K_time, out_file)
            with open("gg_cog_performance_across_K_time_forward_{0}_backward_{1}".format(roll_forward, roll_back), 'wb') as out_file:
                pickle.dump(cog_performance_across_K_time, out_file)
            with open("gg_variance_across_K_time_forward_{0}_backward_{1}".format(roll_forward, roll_back), 'wb') as out_file:
