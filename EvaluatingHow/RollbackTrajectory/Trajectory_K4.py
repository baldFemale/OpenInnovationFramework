...
def func(N=None, K=None, state_num=None, search_iteration=None):
    ...
    for _ in range(search_iteration):
        # G -> G
        generalist_G.feedback_search(roll_back_ratio=1, roll_forward_ratio=0)
        ...
        # S -> G
        generalist_S.feedback_search(roll_back_ratio=1, roll_forward_ratio=0)
        ...
        # G -> S
        specialist_G.feedback_search(roll_back_ratio=1, roll_forward_ratio=0)
        ...
        # S -> S
        specialist_S.feedback_search(roll_back_ratio=1, roll_forward_ratio=0)
