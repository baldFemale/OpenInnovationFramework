...
if __name__ == '__main__':
    ...
    for share_prob in share_prob_list:
        ...
        with open("ss_performance_across_K_share_prob_{}".format(share_prob), 'wb') as out_file:
            pickle.dump(performance_across_K, out_file)
        with open("ss_variance_across_K_share_prob_{}".format(share_prob), 'wb') as out_file:
            pickle.dump(variance_across_K, out_file)
        with open("ss_diversity_across_K_share_prob_{}".format(share_prob), 'wb') as out_file:
