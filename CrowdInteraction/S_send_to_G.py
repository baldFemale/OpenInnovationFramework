...
def func(N=None, K=None, state_num=None, share_prob=None, agent_num=None,
    ...
    # Sharing Crowd
    s_crowd_1 = Crowd(N=N, agent_num=agent_num, landscape=landscape, state_num=state_num,
                           generalist_expertise=0, specialist_expertise=12, label="S", share_prob=share_prob)
    g_crowd_2 = Crowd(N=N, agent_num=agent_num, landscape=landscape, state_num=state_num,
    ...
    for agent_2 in g_crowd_2.agents:
        ...
        domains = agent_2.generalist_domain.copy()
        domains.sort()
...
if __name__ == '__main__':
    ...
    for share_prob in share_prob_list:
        ...
        with open("sg_performance_across_K_share_prob_{}".format(share_prob), 'wb') as out_file:
            pickle.dump(performance_across_K, out_file)
        with open("sg_variance_across_K_share_prob_{}".format(share_prob), 'wb') as out_file:
            pickle.dump(variance_across_K, out_file)
        with open("sg_diversity_across_K_share_prob_{}".format(share_prob), 'wb') as out_file:
