...
if __name__ == '__main__':
    ...
    with open("t_performance_across_K_2", 'wb') as out_file:
        pickle.dump(performance_across_K, out_file)
    with open("t_potential_across_K_2", 'wb') as out_file:
        pickle.dump(potential_across_K, out_file)
    with open("t_original_performance_across_K_2", "wb") as out_file:
        pickle.dump(original_performance_across_K, out_file)
    with open("t_original_potential_across_K_2", "wb") as out_file:
