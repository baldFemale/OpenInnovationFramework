...
def loop(k=0, K=0, exposure_type=None, socialization_freq=None, quality=None, openness=None, S_exposed_to_S=None,
    ...
    C_surface_divergence_G_simulators = []
    C_surface_divergence_S_simulators = []
    D_surface_quality_G_simulators = []
    D_surface_quality_S_simulators = []
    ...
    for landscape_loop in range(landscape_iteration):
        ...
        C_surface_divergence_G_simulators.append(simulator.surface_divergence_G_landscape)
        C_surface_divergence_S_simulators.append(simulator.surface_divergence_S_landscape)
        D_surface_quality_G_simulators.append(simulator.surface_quality_G_landscape)
        D_surface_quality_S_simulators.append(simulator.surface_quality_S_landscape)
    ...
    C_file_name_surface_divergence_G = "4DivergenceG_" + basic_file_name
    C_file_name_surface_divergence_S = "4DivergenceS_" + basic_file_name
    D_file_name_surface_quality_G = "5QualityG" + basic_file_name
    D_file_name_surface_quality_S = "5QualityS" + basic_file_name
    ...
    # mechanism
    with open(C_file_name_surface_divergence_G, 'wb') as out_file:
        pickle.dump(C_surface_divergence_G_simulators, out_file)
    with open(C_file_name_surface_divergence_S, 'wb') as out_file:
        pickle.dump(C_surface_divergence_S_simulators, out_file)

    with open(D_file_name_surface_quality_G, 'wb') as out_file:
        pickle.dump(D_surface_quality_G_simulators, out_file)
    with open(D_file_name_surface_quality_S, 'wb') as out_file:
        pickle.dump(D_surface_quality_S_simulators, out_file)
