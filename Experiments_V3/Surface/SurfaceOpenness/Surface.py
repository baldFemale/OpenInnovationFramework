...
if __name__ == '__main__':
    data_foler = r'e0546117@atlas8.nus.edu.sg:/hpctmp/e0546117/Experiments_V3/Openness'
...
#################################################################
    # Openness, divergence
    surface.generate_surface_outcome(title=fore_title, dimension="Openness", GS_flag="G", y_label="Divergence")
    surface.generate_surface_outcome(title=fore_title, dimension="Openness", GS_flag="S", y_label="Divergence")

    # Composition, Quality
    surface.generate_surface_outcome(title=fore_title, dimension="Openness", GS_flag="G", y_label="Quality")
    surface.generate_surface_outcome(title=fore_title, dimension="Openness", GS_flag="S", y_label="Quality")

    # Openness, utilization
    surface.generate_surface_outcome(title=fore_title, dimension="Openness", GS_flag="G", y_label="Utilization")
    surface.generate_surface_outcome(title=fore_title, dimension="Openness", GS_flag="S", y_label="Utilization")
    ##################################################################
    print("END")
