...
if __name__ == '__main__':
    data_foler = r'e0546117@atlas8.nus.edu.sg:/hpctmp/e0546117/Experiments_V3/Composition'
    output_folder = r'e0546117@atlas8.nus.edu.sg:/hpctmp/e0546117/Experiments_V3\result'
    # data_foler = "C:\Python_Workplace\hpc-0422\Experiments_V3\Composition"
    # output_folder = "C:\Python_Workplace\hpc-0422\Experiments_V3"
    # ###############################################################
    ...
    gs_proportion_list = [0.25, 0.5, 0.75, 1.0]
    ###############################################################
...
#################################################################
    ...
    surface.gs_proportion_list = [0.25, 0.5, 0.75, 1.0]
    surface.generate_surface_outcome(title=fore_title, dimension="Proportion", GS_flag="G", y_label="Divergence")
    surface.gs_proportion_list = [0, 0.25, 0.5, 0.75]
    surface.generate_surface_outcome(title=fore_title, dimension="Proportion", GS_flag="S", y_label="Divergence")

    # Composition, Quality
    surface.gs_proportion_list = [0.25, 0.5, 0.75, 1.0]
    surface.generate_surface_outcome(title=fore_title, dimension="Proportion", GS_flag="G", y_label="Quality")
    surface.gs_proportion_list = [0, 0.25, 0.5, 0.75]
    surface.generate_surface_outcome(title=fore_title, dimension="Proportion", GS_flag="S", y_label="Quality")

    # Openness, utilization
    surface.gs_proportion_list = [0.25, 0.5, 0.75, 1.0]
    surface.generate_surface_outcome(title=fore_title, dimension="Proportion", GS_flag="G", y_label="Utilization")
    surface.gs_proportion_list = [0, 0.25, 0.5, 0.75]
    surface.generate_surface_outcome(title=fore_title, dimension="Proportion", GS_flag="S", y_label="Utilization")
    ##################################################################
    print("END")
