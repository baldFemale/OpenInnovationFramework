...
if __name__ == '__main__':
    data_folder = r'C:\Python_Workplace\hpc-0515\Experiments_V3\Composition'
    output_folder = r'C:\Python_Workplace\hpc-0515\Experiments_V3'
    ###############################################################
