...
if __name__ == '__main__':
    ...
    N = 10
    state_num = 4
    generalist_expertise = 8  # 5 G domains
    specialist_expertise = 12  # 5 S domains
    ...
    with open("t_first_quantile_across_K", 'wb') as out_file:
        pickle.dump(first_quantile_across_K, out_file)
    with open("t_last_quantile_across_K", 'wb') as out_file:
    ...
    with open("t_first_quantile_across_K_time", 'wb') as out_file:
        pickle.dump(first_quantile_across_K_time, out_file)
    with open("t_last_quantile_across_K_time", 'wb') as out_file:
