...
data_folder = r"F:\data\gst-1112\Coordination\gg"
...
plt.xticks(x)
plt.title("Coordination_GG_G1")
plt.legend(frameon=False, ncol=3, fontsize=10)
plt.savefig(data_folder + r"\Coordination_GG_G1.png", transparent=False, dpi=200)
plt.show()
plt.clf()
...
plt.ylabel('Performance', fontweight='bold', fontsize=10)
plt.xticks(x)
plt.title("Coordination_GG_G2")
plt.legend(frameon=False, ncol=3, fontsize=10)
plt.savefig(data_folder + r"\Coordination_GG_G2.png", transparent=False, dpi=200)
plt.show()
plt.clf()
print("END")
