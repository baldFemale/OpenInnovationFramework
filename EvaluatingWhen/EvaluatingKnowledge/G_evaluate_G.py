...
def func(N=None, K=None, state_num=None, individual_expertise=None, crowd_expertise=None, agent_num=None,
    ...
    crowd = Crowd(N=N, agent_num=50, landscape=landscape, state_num=state_num,
                           generalist_expertise=crowd_expertise, specialist_expertise=0, label="G")
...
if __name__ == '__main__':
    ...
    for crowd_knowledge in crowd_knowledge_list:
        ...
        with open("gg_performance_across_K_{0}".format(crowd_knowledge), 'wb') as out_file:
            pickle.dump(average_performance_across_K, out_file)
        with open("gg_best_performance_across_K_{0}".format(crowd_knowledge), 'wb') as out_file:
            pickle.dump(best_performance_across_K, out_file)
        with open("gg_variance_across_K_{0}".format(crowd_knowledge), 'wb') as out_file:
            pickle.dump(variance_across_K, out_file)
        with open("gg_diversity_across_K_{0}".format(crowd_knowledge), 'wb') as out_file:
