...
if __name__ == '__main__':
    ...
    for crowd_knowledge in crowd_knowledge_list:
        ...
        with open("gs_performance_across_K_{0}".format(crowd_knowledge), 'wb') as out_file:
            pickle.dump(average_performance_across_K, out_file)
        with open("gs_best_performance_across_K_{0}".format(crowd_knowledge), 'wb') as out_file:
            pickle.dump(best_performance_across_K, out_file)
        with open("gs_variance_across_K_{0}".format(crowd_knowledge), 'wb') as out_file:
            pickle.dump(variance_across_K, out_file)
        with open("gs_diversity_across_K_{0}".format(crowd_knowledge), 'wb') as out_file:
