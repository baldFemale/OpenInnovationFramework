...
class ParentLandscape:
    ...
    def __init__(self, N, state_num=4):
        ...
        self.IM, self.dependency_map = np.ones(self.N), [[1]*(self.N - 1)]*self.N  # full rank IM
    ...
    #     """
    #     Do not need the fitness cache in parent landscape
    #     :return:
    #     """
    ...
    def initialize(self, norm=True):
        """
        Cache the Fitness Configuration
