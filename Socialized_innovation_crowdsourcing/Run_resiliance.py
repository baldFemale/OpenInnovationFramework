...
def loop(k=0, K=0,):
    ...
    for parent_loop in range(parent_iteration):
        ...
        if simulator.landscape.k < 10:
            basic_file_name =  simulator.IM_type + '_N' + str(simulator.N) + \
                              '_K' + str(simulator.K) + '_k0' + str(simulator.landscape.k) + '_E' + str(
                simulator.knowledge_num)
        else:
            basic_file_name =  simulator.IM_type + '_N' + str(simulator.N) + \
                              '_K' + str(simulator.K) + '_k' + str(simulator.landscape.k) + '_E' + str(
                simulator.knowledge_num)
