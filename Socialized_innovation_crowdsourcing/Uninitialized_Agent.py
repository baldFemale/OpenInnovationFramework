...
class Agent:
    """Make soem adjustment toward a idea polishment
    such that Agents could start from particular position due to their exposure"""
    ...
    def change_cog_state_to_state(self, cog_state=None):
        """
        After convergence, we need to mirror the cognitive fitness into true fitness
