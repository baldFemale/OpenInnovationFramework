...
if __name__ == '__main__':
    ...
    for alpha in alpha_list:
        ...
        with open("s_first_quantile_across_K_alpha_{0}".format(alpha), 'wb') as out_file:
            pickle.dump(first_quantile_across_K, out_file)
        with open("s_last_quantile_across_K_alpha_{0}".format(alpha), 'wb') as out_file:
        ...
        with open("s_first_quantile_across_K_time_alpha_{0}".format(alpha), 'wb') as out_file:
            pickle.dump(first_quantile_across_K_time, out_file)
        with open("s_last_quantile_across_K_time_alpha_{0}".format(alpha), 'wb') as out_file:
