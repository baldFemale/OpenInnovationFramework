...
if __name__ == '__main__':
    ...
    for alpha in alpha_list:
        ...
        with open("mixed_gs_ave_performance_across_K_alpha_{0}".format(alpha), 'wb') as out_file:
            pickle.dump(ave_performance_across_K, out_file)
        with open("mixed_gs_best_performance_across_K_alpha_{0}".format(alpha), 'wb') as out_file:
            pickle.dump(best_performance_across_K, out_file)
        with open("mixed_gs_variance_across_K_alpha_{0}".format(alpha), 'wb') as out_file:
