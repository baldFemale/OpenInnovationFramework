...
if __name__ == '__main__':
    data_foler = r'C:\Python_Workplace\hpc-0413\Experiments\Composition'
    output_folder = r'C:\Python_Workplace\hpc-0413'
    ###############################################################
    ...
    evaluator.generate_one_dimension_figure(title=fore_title, dimension="Proportion", y_label="Maximum", show_variance=False, percentage=1, top_coverage=None)
