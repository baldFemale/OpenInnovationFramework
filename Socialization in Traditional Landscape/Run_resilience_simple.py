...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# In this version, we don't use dynamic landscape design.
# Instead, we use traditional landscape iteration, and measure the variation
# The socialization process is added into the collective search process
# There could be multiple intervention between
