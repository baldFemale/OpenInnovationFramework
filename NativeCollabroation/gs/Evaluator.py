...
data_folder = r"F:\data\gst-1112\Autonomy_1\gs"
...
plt.xticks(x)
plt.title("Autonomy_GS_G")
plt.legend(frameon=False, ncol=3, fontsize=10)
plt.savefig(data_folder + r"\Autonomy_GS_G.png", transparent=False, dpi=200)
plt.show()
plt.clf()


# G2
plt.plot(x, s_performance_1, "g-", label="Zero")
...
plt.ylabel('Performance', fontweight='bold', fontsize=10)
plt.xticks(x)
plt.title("Autonomy_GS_S")
plt.legend(frameon=False, ncol=3, fontsize=10)
plt.savefig(data_folder + r"\Autonomy_GS_S.png", transparent=False, dpi=200)
plt.show()
plt.clf()
print("END")
