...
data_folder = r"F:\data\gst-1112\Autonomy_1\ss"
...
plt.xticks(x)
plt.title("Autonomy_SS_S1")
plt.legend(frameon=False, ncol=3, fontsize=10)
plt.savefig(data_folder + r"\Autonomy_SS_S1.png", transparent=False, dpi=200)
plt.show()
plt.clf()
...
plt.ylabel('Performance', fontweight='bold', fontsize=10)
plt.xticks(x)
plt.title("Autonomy_SS_S2")
plt.legend(frameon=False, ncol=3, fontsize=10)
plt.savefig(data_folder + r"\Autonomy_SS_S2.png", transparent=False, dpi=200)
plt.show()
plt.clf()
print("END")
