...
class Simulator:
    ...
    def set_landscape(self, K=0, k=0, IM_type=None,factor_num=0, influential_num=0, show=False):
    ...
    def set_agent(self, name="None", lr=0, generalist_num=0, specialist_num=0, show=False):
...
if __name__ == '__main__':
    ...
    for K in K_list:
        for each_agent_type, generalist_num, specialist_num in zip(agent_name, generalist_list, specialist_list):
            ...
            E_file_name_agent_knowledge = "Knowledge_" + A_file_name
