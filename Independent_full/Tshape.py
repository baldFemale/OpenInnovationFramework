...
class Tshape:
    def __init__(self, N=None, landscape=None, state_num=4, generalist_expertise=None, specialist_expertise=None):
        ...
        self.cog_partial_fitness = self.landscape.query_partial_fitness(
            cog_state=self.cog_state, generalist_domain=self.generalist_domain, specialist_domain=self.specialist_domain)
    ...
    def search(self):
        ...
        next_cog_partial_fitness = self.landscape.query_partial_fitness(
            cog_state=next_cog_state, generalist_domain=self.generalist_domain, specialist_domain=self.specialist_domain)
...
if __name__ == '__main__':
    ...
    K = 0
    state_num = 4
    generalist_expertise = 0  # 2 G domains
    specialist_expertise = 36  # 7 S domains
