...
# mp version
def func(N=None, K=None, agent_num=None, generalist_expertise=None, search_iteration=None, loop=None, return_dict=None, sema=None):
    np.random.seed(None)
    ...
    receiver_crowd = Crowd(N=N, agent_num=agent_num, landscape=landscape, state_num=4,
                           specialist_expertise=0, generalist_expertise=generalist_expertise, label="G")
...
if __name__ == '__main__':
    ...
    for generalist_expertise in generalist_expertise_list:
        ...
        with open("sg_joint_satisfaction_across_K_G_{0}".format(generalist_expertise), 'wb') as out_file:
