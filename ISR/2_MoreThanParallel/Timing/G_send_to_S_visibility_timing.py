...
if __name__ == '__main__':
    ...
    for visibility_start in visibility_start_list:
        ...
        with open("gs_visibility_start_{0}_breakthrough_fitness_across_K_size_{1}".format(
                visibility_start, agent_num), 'wb') as out_file:
            pickle.dump(breakthrough_fitness_across_K, out_file)

        with open("gs_visibility_start_{0}_breakthrough_rank_across_K_size_{1}".format(
                visibility_start, agent_num), 'wb') as out_file:
            pickle.dump(breakthrough_rank_across_K, out_file)

        with open("gs_visibility_start_{0}_diversity_across_K_size_{1}".format(
                visibility_start, agent_num), 'wb') as out_file:
