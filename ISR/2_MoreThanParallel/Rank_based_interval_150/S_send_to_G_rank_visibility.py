...
if __name__ == '__main__':
    ...
    for fitness_threshold in fitness_threshold_list:
        ...
        with open("sg_rank_based_fitness_threshold_{0}_interval_{1}_breakthrough_fitness_across_K_size_{2}".format(
                fitness_threshold, visibility_interval, agent_num), 'wb') as out_file:
            pickle.dump(breakthrough_fitness_across_K, out_file)

        with open("sg_rank_based_fitness_threshold_{0}_interval_{1}_breakthrough_rank_across_K_size_{2}".format(
                fitness_threshold, visibility_interval, agent_num), 'wb') as out_file:
            pickle.dump(breakthrough_rank_across_K, out_file)

        with open("sg_rank_based_fitness_threshold_{0}_interval_{1}_diversity_across_K_size_{2}".format(
                fitness_threshold, visibility_interval, agent_num), 'wb') as out_file:
            pickle.dump(diversity_across_K, out_file)

        with open("sg_rank_based_fitness_threshold_{0}_interval_{1}_pairwise_diversity_across_K_size_{2}".format(
                fitness_threshold, visibility_interval, agent_num), 'wb') as out_file:
