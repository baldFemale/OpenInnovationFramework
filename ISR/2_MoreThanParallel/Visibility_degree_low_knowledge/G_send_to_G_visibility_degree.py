...
if __name__ == '__main__':
    ...
    for visibility_prob in visibility_prob_list:
        ...
        with open("gg_visibility_prob_{0}_interval_{1}_adopted_solution_fitness_across_K_size_{2}".format(
                visibility_prob, visibility_interval, agent_num), 'wb') as out_file:
            pickle.dump(adopted_solution_fitness_across_K, out_file)

        with open("gg_visibility_prob_{0}_interval_{1}_adopted_solution_fitness_across_time_across_K_size_{2}".format(
                visibility_prob, visibility_interval, agent_num), 'wb') as out_file:
