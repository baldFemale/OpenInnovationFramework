...
plt.xticks(x)
plt.title("Topdown_SS_S1")
plt.legend(frameon=False, ncol=3, fontsize=10)
plt.savefig(data_folder + r"\Topdown_SS_S1.png", transparent=False, dpi=200)
plt.show()
plt.clf()
...
plt.ylabel('Performance', fontweight='bold', fontsize=10)
plt.xticks(x)
plt.title("Topdown_SS_S2")
plt.legend(frameon=False, ncol=3, fontsize=10)
plt.savefig(data_folder + r"\Topdown_SS_S2.png", transparent=False, dpi=200)
plt.show()
plt.clf()
print("END")
